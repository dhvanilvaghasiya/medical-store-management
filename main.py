...
def open_win():
    ...
    apt.title('Dhvanil Vaghasiya')
    Label(apt, text="Dhvanil Vaghasiya", font=('ariel', 45, ), fg='blue').grid(row=1, column=1)
...
def again():
    ...
    root.title('Dhvanil Vaghasiya')
    Label(root, text="Dhvanil Vaghasiya", font=('ariel', 45, ), fg='blue').grid(row=3, column=1)
